...
function exportCsv(transactions: Transaction[]) {
  const header = '"Data Vencimento","Descrição","Fornecedor","Categoria","Conta","Valor","Status"'
    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Gerencie todas as despesas e obrigações da empresa</p>
        </div>
